...
class MusicPlayer {
  ...
  static const String address = 'http://10.0.2.2:5000/music?id='; // for emulator
  //static const String address = 'http://192.168.25.4:5000/music?id='; // for device
